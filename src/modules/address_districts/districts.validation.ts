...
import { allowableWhereFields, allowableWhereInFields } from '@app/database/models/address_districts.schema.js';
...
export const createValidation = z.object({
    ...
    regency: z.string().trim().regex(REGEX_OBJECTID, objectid_refine.params),
    province: z.string().trim().regex(REGEX_OBJECTID, objectid_refine.params)
});
