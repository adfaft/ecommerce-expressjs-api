...
import { allowableWhereFields, allowableWhereInFields, DiscountUnitEnum } from '@app/database/models/product_discounts.schema.js';
...
export const createValidation = z.object({
    ...
    discountUnit: z.enum(DiscountUnitEnum),
});
