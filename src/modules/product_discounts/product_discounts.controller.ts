...
import validation, { createValidation, findByIdValidation, findQueryValidation, updateValidation } from './product_discounts.validation.js';

import Model, { querySearch } from '@app/database/models/product_discounts.schema.js';
import z from 'zod';
